...
class Code
 {
     ...
     public $height;
     public $img;
     public $str="QWERTYUIPASDFGHJKZXCVBNM23456789";
     ...
     function fillWords(){
                ...
                for($i=0;$i<4;$i){
                        ...
                        imagettftext($this->img,mt_rand(25,35),mt_rand(-10,10),$i*4010,mt_rand(30,40),$this->getcolor($this->img,"l"),"font.ttf",$letter);
                    }
         session_start();
